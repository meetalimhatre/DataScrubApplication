sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/ng/admin/securityui/securityui/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#UserSecurityAdministration-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#UserSecurityAdministration-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.ng.admin.securityui.securityui.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/ng/admin/securityui/securityui/localService/mockserver"], function (mockserver) {
